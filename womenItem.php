<?php require_once 'config.php' ;
	if(isset($_GET["search"])){
		...
		$chk=implode(",",$myArray);
		$sql="SELECT * FROM item where category='WOMEN' AND type IN ($chk) AND unit_price BETWEEN $min AND $max AND size='s'" ;
	}else{
		$sql="SELECT * FROM item where category='WOMEN' AND size='s'"; 
	}
	?>
<!-- 
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="src/css/womenItem.css" type="text/css">
