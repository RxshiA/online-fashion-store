<?php require_once 'config.php' ;
	if(isset($_GET["search"])){
		...
		$chk=implode(",",$myArray);
		$sql="SELECT * FROM item where category='MEN' AND size='s'AND type IN ($chk) AND unit_price BETWEEN $min AND $max" ;
	}else{
		$sql="SELECT * FROM item where category='MEN' AND size='s'"; 
	}
	?>
